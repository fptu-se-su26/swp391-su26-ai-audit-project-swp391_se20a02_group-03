  ...
  if (!isGoogleAuthConfigured()) {
    return (
      <button
        type="button"
        disabled
        title="Chức năng đăng nhập Google chưa được cấu hình trên server"
        className="w-full flex items-center justify-center gap-3 rounded-md font-medium text-sm transition-all duration-200 cursor-not-allowed select-none"
        style={{
          height: '44px',
