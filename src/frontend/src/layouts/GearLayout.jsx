    ...
    <div className="min-h-screen flex flex-col bg-[#f5f9fc]">
      <header className="h-14 bg-white border-b border-[#e0ecf0] flex items-center px-7 gap-6 sticky top-0 z-[100] shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <Link to="/gear/cart" className="w-[34px] h-[34px] rounded-full bg-transparent border-none cursor-pointer flex items-center justify-center text-slate-500 transition-all hover:bg-[rgba(13,138,138,0.08)] hover:text-[#0d8a8a] relative" aria-label="Cart">
