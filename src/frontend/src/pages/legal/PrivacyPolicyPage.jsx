    ...
    <div className="min-h-screen flex flex-col bg-paper">
      ...
      <div className="container max-w-[800px] py-16" ref={contentRef}>
        <div className="prose max-w-none">
          ...
          <h2 className="font-heading text-[1.4rem] uppercase text-foreground mt-10 mb-4">1. Thông tin chúng tôi thu thập</h2>
          <p className="text-foreground-muted mb-4 leading-[1.7]">
          ...
          <h2 className="font-heading text-[1.4rem] uppercase text-foreground mt-10 mb-4">2. Cách chúng tôi sử dụng thông tin</h2>
          <p className="text-foreground-muted mb-4 leading-[1.7]">
          ...
          <h2 className="font-heading text-[1.4rem] uppercase text-foreground mt-10 mb-4">3. Bảo mật dữ liệu</h2>
          ...
          <h2 className="font-heading text-[1.4rem] uppercase text-foreground mt-10 mb-4">4. Liên hệ</h2>
          <p className="text-foreground-muted mb-8 leading-[1.7]">
            Nếu bạn có câu hỏi về Chính sách bảo mật này, vui lòng liên hệ: <a href="mailto:privacy@pro-sport.com" className="text-accent hover:underline">privacy@pro-sport.com</a>
          </p>
        </div>
      </div>
