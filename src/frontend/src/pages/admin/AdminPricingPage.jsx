          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input type="number" defaultValue="120000" className="border border-slate-200 rounded-lg px-3 py-1.5 w-32 text-right focus:border-[#14B8A6] outline-none" />
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-slate-700">Sân Pickleball (Premium)</span>
                <input type="number" defaultValue="180000" className="border border-slate-200 rounded-lg px-3 py-1.5 w-32 text-right focus:border-[#14B8A6] outline-none" />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input type="number" defaultValue="1.5" step="0.1" className="border border-slate-200 rounded-lg px-3 py-1.5 w-20 text-center focus:border-[#14B8A6] outline-none bg-amber-50 text-amber-700 font-bold" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-slate-500">x</span>
                  <input type="number" defaultValue="1.2" step="0.1" className="border border-slate-200 rounded-lg px-3 py-1.5 w-20 text-center focus:border-[#14B8A6] outline-none font-bold" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-slate-500">x</span>
                  <input type="number" defaultValue="2.0" step="0.1" className="border border-slate-200 rounded-lg px-3 py-1.5 w-20 text-center focus:border-[#14B8A6] outline-none font-bold text-red-500 bg-red-50" />
                </div>
              </div>
            </div>
          </div>
