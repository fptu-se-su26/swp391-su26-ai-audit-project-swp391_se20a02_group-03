...
const messages = [
  ...
  { id: 4, type: 'system', text: 'Sarah J. joined the match', icon: <User size={14} /> },
]
    ...
    <MatchProLayout>
      <div className="flex h-[calc(100vh-60px)] bg-[#f0f7fa]">
        ...
        <div className="w-[260px] shrink-0 bg-white border-r border-[#e0ecf0] py-5 flex flex-col gap-1 overflow-y-auto">
          <h2 className="font-['Oswald'] text-[1.2rem] font-bold text-foreground px-4 mb-3">Messages</h2>
          <div className="flex items-center gap-2 bg-[#f0f7fa] border-[1.5px] border-[#e0ecf0] rounded-full px-3.5 py-2 mx-4 mb-3">
            ...
            <input type="text" placeholder="Tìm kiếm chats..." id="chat-search" className="border-none bg-transparent font-['Inter'] text-[0.85rem] text-foreground w-full outline-none placeholder:text-slate-400" />
          </div>
          {conversations.map(c => (
            <button
              key={c.id}
        ...
        <div className="flex-1 flex flex-col bg-white border-l border-[#e0ecf0]">
          ...
          <div className="flex items-center gap-3.5 px-6 py-4 border-b border-[#e0ecf0] bg-white">
            ...
            <div>
              ...
              <p className="text-[0.78rem] text-slate-400 mt-0.5 flex items-center gap-1"><MapPin size={12} /> Rucker Park · 6/6 Players Joined</p>
            </div>
          ...
          <div className="flex items-center gap-2.5 px-6 py-3.5 border-t border-[#e0ecf0] bg-white">
            <button className="w-9 h-9 rounded-full bg-transparent border-none cursor-pointer flex items-center justify-center text-slate-400 transition-all shrink-0 hover:text-[#14B8A6] hover:bg-[rgba(13,138,138,0.08)]" aria-label="Attach">
            ...
            />
            <button className="w-9 h-9 rounded-full bg-transparent border-none cursor-pointer flex items-center justify-center text-slate-400 transition-all shrink-0 hover:text-[#14B8A6] hover:bg-[rgba(13,138,138,0.08)]" aria-label="Emoji">
            ...
            <button className="w-10 h-10 rounded-full bg-[#14B8A6] border-none cursor-pointer flex items-center justify-center transition-all shrink-0 hover:bg-[var(--theme-primary)]" aria-label="Send">
