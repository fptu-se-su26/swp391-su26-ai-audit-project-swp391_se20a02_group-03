      ...
      <div className="font-sans pb-12 flex flex-col gap-8">
        ...
        <div className="pt-6 px-4 text-center flex flex-col items-center">
          ...
          <div className="flex gap-3 mt-5 w-full">
            <button className="flex-1 bg-slate-900 text-[var(--theme-primary)] text-sm font-semibold py-3 rounded-xl transition-all active:scale-[0.98]">
              Edit Profile
            </button>
        ...
        <div className="px-4">
          <div className="bg-slate-950 rounded-3xl p-6 text-[var(--theme-primary)] shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10 mb-8">
              <h2 className="text-4xl font-bold tracking-tight text-[var(--theme-primary)]">$240.50</h2>
            </div>
            
            <div className="relative z-10 space-y-3 mb-6 border-t border-border-default pt-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[var(--theme-surface-hover)] flex items-center justify-center text-[var(--theme-primary)]"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M12 8v8"/><path d="M8 12h8"/></svg></div>
                  <div>
                    <p className="text-sm font-medium text-[var(--theme-primary)]">Pro Shop Discount</p>
                    <p className="text-xs text-slate-400 mt-0.5">Expires in 3 days</p>
                  </div>
                </div>
                <span className="text-sm font-semibold text-[var(--theme-primary)]">-15%</span>
              </div>
            </div>
