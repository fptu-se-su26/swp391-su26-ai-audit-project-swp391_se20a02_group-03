...
const audiences = ['All Active Members', 'Tennis Players', 'Padel Enthusiasts', 'Lapsed Users', '+ Custom Segment']
...
const recentBroadcasts = [
  ...
  { status: 'SENT', statusColor: '#22c55e', date: 'Yesterday', title: 'New Padel Courts Available!', open: '68%', click: '12%' },
        ...
        <div className="db-main-grid">
          ...
          <div className="db-campaign-card">
            ...
            <div className="db-field">
              ...
              <input id="camp-name" type="text" placeholder="e.g., Summer Tennis League Promo" className="db-input" />
            </div>
