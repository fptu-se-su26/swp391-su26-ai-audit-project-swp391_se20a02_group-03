      ...
      <div className="mob-home">
        ...
        <div className="mh-hero">
          <div className="mh-hero-img-wrap">
            <img src="https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=600&q=80" alt="Pickleball Court" className="mh-hero-img" />
        ...
        <div className="mh-content">
          ...
          <div className="mh-filters">
            <button className="mh-filter-btn active">Pickleball</button>
            <button className="mh-filter-btn">Pickleball</button>
            <button className="mh-filter-btn">Pickleball</button>
            <button className="mh-filter-btn">Badminton</button>
          </div>
            ...
            <div className="mh-group-list">
              <div className="mh-group-card">
                ...
                <div className="mh-group-info">
                  <h4 className="mh-group-name">Northside Pickleball Pros</h4>
              ...
              <div className="mh-group-card">
                ...
                <div className="mh-group-info">
                  <h4 className="mh-group-name">Downtown Pickleball Club</h4>
          ...
          <section className="mh-section">
            ...
            <div className="mh-players-scroll">
              <div className="mh-player-card">
                ...
                <p className="mh-player-level">Pickleball • Level 4.5</p>
              ...
              <div className="mh-player-card">
                ...
                <p className="mh-player-level">Pickleball • Casual</p>
