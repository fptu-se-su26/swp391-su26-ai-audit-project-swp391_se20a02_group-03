          ...
          <div className="ac-courts-grid">
            ...
            <div className="ac-court-card">
              <div className="ac-court-img-wrap">
                <img src="https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=600&q=80" alt="Tennis Court" className="ac-court-img" />
                <div className="ac-court-tags">
                  <span className="ac-tag ac-tag--sport"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72"/></svg>TENNIS</span>
            ...
            <div className="ac-court-card">
              <div className="ac-court-img-wrap">
                <img src="https://images.unsplash.com/photo-1622227432807-91eb590c31ab?w=600&q=80" alt="Padel Court" className="ac-court-img" />
                <div className="ac-court-tags">
                  <span className="ac-tag ac-tag--sport"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72"/></svg>PADEL</span>
                  <span className="ac-tag ac-tag--booked">BOOKED</span>
                </div>
              </div>
              <div className="ac-court-info">
                <h2 className="ac-court-name">Padel Court A</h2>
