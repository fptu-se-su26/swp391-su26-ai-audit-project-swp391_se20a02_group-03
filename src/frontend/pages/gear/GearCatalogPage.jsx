...
const products = [
  { id: 1, name: 'Wilson Pro Staff RF97', category: 'TENNIS', badge: 'NEW', price: '$15/hr', deposit: '$50', img: 'https://images.unsplash.com/photo-1617083934551-1af7da84de49?w=400&q=80', type: 'rental' },
  { id: 2, name: 'Babolat Technical Viper', category: 'PADEL', badge: 'PREMIUM', price: '$18/hr', deposit: '$60', img: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&q=80', type: 'rental' },
  { id: 3, name: 'Head Tour Balls (3-Pack)', category: 'TENNIS', badge: 'DEMO', price: '$8/tube', deposit: null, img: 'https://images.unsplash.com/photo-1612452040814-e42b8f2da8ea?w=400&q=80', type: 'purchase', stock: 'Available' },
  { id: 4, name: 'TaylorMade P790 Irons', category: 'GOLF', badge: 'PREMIUM', price: '$45/day', deposit: '$150', img: 'https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?w=400&q=80', type: 'rental' },
]

const sports = ['Tennis', 'Padel', 'Golf', 'Squash']
const conditions = ['Premium', 'New', 'Demo']

export default function GearCatalogPage() {
  const [selected, setSelected] = useState(['Tennis', 'Padel'])
