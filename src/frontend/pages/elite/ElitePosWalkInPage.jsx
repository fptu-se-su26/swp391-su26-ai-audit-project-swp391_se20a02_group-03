            ...
            <div className="ep-courts-grid">
              ...
              <div className="ep-court-card active">
                <div className="ep-court-card-top">
                  <div>
                    <h3 className="ep-court-name">Pickleball Court 1</h3>
              ...
              <div className="ep-court-card">
                <div className="ep-court-card-top">
                  <div>
                    <h3 className="ep-court-name">Pickleball Court 2</h3>
              ...
              <div className="ep-court-card">
                <div className="ep-court-card-top">
                  <div>
                    <h3 className="ep-court-name">Pickleball Court 3</h3>
              ...
              <div className="ep-court-card">
                <div className="ep-court-card-top">
                  <div>
                    <h3 className="ep-court-name">Pickleball Court 4</h3>
            ...
            <div className="ep-checkout-card ep-order-card">
              ...
              <div className="ep-order-item">
                <div className="ep-order-item-top">
                  <div>
                    <p className="ep-order-item-name">Pickleball Court 1</p>
