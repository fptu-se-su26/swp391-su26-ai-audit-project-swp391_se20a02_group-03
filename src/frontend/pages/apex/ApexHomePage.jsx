...
const bookings = [
  { id: 1, name: 'Indoor Tennis Court A', time: 'Today, 18:00 - 20:00', status: 'CONFIRMED', icon: '🎾', iconBg: '#0d8a8a' },
  { id: 2, name: 'Main Basketball Arena', time: 'Tomorrow, 10:00 - 11:30', status: 'CONFIRMED', icon: '🏀', iconBg: '#f59e0b' },
]
          ...
          <div className="apex-card">
            ...
            <div className="apex-rental-item">
              <div className="apex-rental-item__info">
                <p className="apex-rental-item__name">Pro Tennis Racket</p>
